...
const startApp = async () => {
  ...
  // Kept in sync with the packaged appId (com.plcstudio.desktop) so Windows associates
  // the taskbar icon with THIS app's .ico instead of the stock Cherry Studio icon.
  ...
  electronApp.setAppUserModelId('com.plcstudio.desktop')
