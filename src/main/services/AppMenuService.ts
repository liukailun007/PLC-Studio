...
import { SOURCE_CODE_URL } from '@shared/utils/constants'
import {
  type CommandId,
  evaluateContextExpr,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            click: () => {
              void shell.openExternal(`${SOURCE_CODE_URL}/issues/new/choose`)
            }
          },
          {
            type: 'custom',
            ...
            click: () => {
              void shell.openExternal(`${SOURCE_CODE_URL}/releases`)
            }
          }
        ]
      }
