...
>
> PLC Studio 是基于开源项目 [Cherry Studio](https://github.com/CherryHQ/cherry-studio)（社区版，AGPL-3.0）修改的版本。
> 本程序基于 Cherry Studio 社区版修改，修改者：**智控堂**。
...
> ---
>
> PLC Studio is a modified version of the open-source project [Cherry Studio](https://github.com/CherryHQ/cherry-studio) (Community Edition, AGPL-3.0).
> This program is a modified version of the Cherry Studio Community Edition, modified by **智控堂**.
